...
function fa2RegulationCard(){
  ...
  return `<div class="card fa2-reg-settings-card"><div class="fa2-reg-settings-head"><div><span>FANTAASTA2.0 · A7.0.0</span><h3>Regolamento Lega</h3><p>Solo parametri necessari per gestire budget, rose, strategia e sessioni d'asta.</p></div><b>LOCALE</b></div>
